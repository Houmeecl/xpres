                  ...
                  <div className="hidden md:flex items-center mr-2">
                    ...
                    <Avatar className="h-8 w-8">
                      <AvatarFallback className="bg-blue-100 text-blue-600 text-xs">
                        {user.username?.substring(0, 2).toUpperCase() || "SV"}
                      </AvatarFallback>
                    </Avatar>
                  </div>
        ...
        <div className="hidden md:block bg-white border-b border-gray-100">
          <div className="container mx-auto px-4">
            <nav className="flex space-x-6">
              <Button 
                variant="link" 
                className="text-gray-600 hover:text-blue-600 font-normal text-sm h-12"
              ...
              <Button 
                variant="link" 
                className="text-gray-600 hover:text-blue-600 font-normal text-sm h-12"
                onClick={() => setLocation("/supervisor/zones")}
              >
        ...
        <div className="md:hidden bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 py-2">
            <nav className="flex flex-col">
              <Button 
                variant="link" 
                className="text-gray-600 hover:text-blue-600 justify-start h-10 px-0 font-normal"
                onClick={() => {
              ...
              <Button 
                ...
                className="text-gray-600 hover:text-blue-600 justify-start h-10 px-0 font-normal"
                onClick={() => {
                  setLocation("/supervisor/partners");
                  setMenuOpen(false);
                }}
              >
                <Store className="h-4 w-4 mr-2" />
              ...
              <Button 
                ...
                className="text-gray-600 hover:text-blue-600 justify-start h-10 px-0 font-normal"
                onClick={() => {
                  setLocation("/supervisor/sellers");
                  setMenuOpen(false);
                }}
              >
                <Users className="h-4 w-4 mr-2" />
              ...
              <Button 
                ...
                className="text-gray-600 hover:text-blue-600 justify-start h-10 px-0 font-normal"
                onClick={() => {
                  setLocation("/supervisor/reports");
                  setMenuOpen(false);
                }}
              >
                <BarChart3 className="h-4 w-4 mr-2" />
              ...
              <Button 
                ...
                className="text-gray-600 hover:text-blue-600 justify-start h-10 px-0 font-normal"
                onClick={() => {
                  setLocation("/supervisor/profile");
                  setMenuOpen(false);
                }}
              >
