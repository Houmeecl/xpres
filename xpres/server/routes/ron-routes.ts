 ...
 */
ronRouter.get('/sessions', isAuthenticated, isCertifier, async (req: Request, res: Response) => {
  try {
 ...
 */
ronRouter.post('/sessions', isAuthenticated, isCertifier, async (req: Request, res: Response) => {
  try {
 ...
 */
ronRouter.get('/sessions/:id', isAuthenticated, async (req: Request, res: Response) => {
  try {
 ...
 */
ronRouter.patch('/sessions/:id', isAuthenticated, isCertifier, async (req: Request, res: Response) => {
  try {
    const sessionId = req.params.id;
 ...
 */
ronRouter.get('/session/:id/video-tokens', isAuthenticated, async (req: Request, res: Response) => {
  try {
    const sessionId = req.params.id;
    ...
    sendAgoraTokens(res, channelName, true);
  } catch (error) {
 ...
 */
ronRouter.get('/public/session/:code', async (req: Request, res: Response) => {
  try {
 ...
 */
ronRouter.get('/public/session/:code/tokens', async (req: Request, res: Response) => {
  try {
    const sessionCode = req.params.code;
 ...
 */
ronRouter.get('/public/app-id', async (req: Request, res: Response) => {
  try {
    sendAgoraAppId(res);
  } catch (error) {
