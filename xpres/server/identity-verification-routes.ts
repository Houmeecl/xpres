...
identityVerificationRouter.post("/verify-selfie", upload.single("photo"), async (req: Request, res: Response) => {
  try {
...
identityVerificationRouter.get("/tramite/:id", async (req: Request, res: Response) => {
  try {
...
identityVerificationRouter.post("/tramite", async (req: Request, res: Response) => {
  try {
