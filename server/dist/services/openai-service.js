...
class OpenAIService {
     ...
     */
    async generateStrategicAnalysis(analysisType, data, options = {}) {
     ...
     */
    buildAnalysisPrompt(analysisType, data, depth, includeRecommendations) {
     ...
     */
    async generateMarketingEmail(objective, audience, productInfo, options = {}) {
        // Configurar opciones por defecto
        const model = options.model || "gpt-4o";
